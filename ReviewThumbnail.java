...
public class ReviewThumbnail extends JPanel
{
	...
	public ReviewThumbnail(Product p, Review r)
	{
		...
		lbltitle.setBackground(UIManager.getColor("Button.shadow"));
		lbltitle.setBounds(150, 23, 250, 29);
		lbltitle.setFont(new Font("Lucida Sans", Font.BOLD, 20));
		this.add(lbltitle);
		
		JLabel lblmyrating = new JLabel("My Rating: "+Double.toString(r.rating));
		lblmyrating.setBackground(UIManager.getColor("Button.shadow"));
		lblmyrating.setBounds(150, 23, 250, 79);
		lblmyrating.setFont(new Font("Lucida Sans", Font.BOLD, 13));
		this.add(lblmyrating);
