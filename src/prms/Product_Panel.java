...
public class Product_Panel extends JPanel
{
	...
	public Product_Panel(Product p, Vector <Review> V)
	{
		...
		lblAverageRating = new JLabel("Average Rating: "+Double.toString(p.avg_rating),SwingConstants.CENTER);
		...
		JLabel lblNewLabel = new JLabel("Seller Rating: "+Double.toString(p.sellerrating),SwingConstants.CENTER);
