...
public class ClientGUI extends JFrame 
{
	...
	public ClientGUI(String name, Client C,Socket clientsocket, ObjectOutputStream output, ObjectInputStream input) throws IOException, ClassNotFoundException 
	{
	  ...
	  //----------------- Beauty and Healthcare Panel ------------------
	    ...
	    Image imageAmeya=ImageIO.read(Toolkit.getDefaultToolkit().getClass().getResource("/Ameya.jpg"));
	    ...
	    Image imageAmogh=ImageIO.read(Toolkit.getDefaultToolkit().getClass().getResource("/Amogh.JPG"));
	    ...
	    Image imageKhisti=ImageIO.read(Toolkit.getDefaultToolkit().getClass().getResource("/Khisti.jpg"));
	  ...
	  //============================= MENU & MENU BAR RELATED OPERATIONS =================================
	    ...
	    URL urlSearch=Toolkit.getDefaultToolkit().getClass().getResource("/SearchButton.png");
	  ...
	  //-------------------------CLOSE ACTION LISTENER --------------------------
	    ...
	    JLabel lblCopyright = new JLabel("© Amogh, Ameya, Khisti- 2018");
